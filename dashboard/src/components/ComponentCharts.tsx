...
interface ComponentChartsProps {
...
export function ComponentCharts({ components }: ComponentChartsProps) {
  // Build stacked bar data per component
  ...
  return (
    <div className="bg-slate-900 rounded-lg border border-slate-800 p-4">
      <div className="text-xs text-slate-500 uppercase tracking-wider mb-3 font-semibold">SP per Component by Status</div>
