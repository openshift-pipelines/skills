...
@.planning/phases/02-fix-blockers/02-03-SUMMARY.md
...
**From Phase 2 Plan 2:**
- /osp:wait-for-builds skill available for monitoring pipelines
...
<output>
After completion, create `.planning/phases/02-fix-blockers/02-04-SUMMARY.md`:
